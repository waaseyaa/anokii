...
final class AdminModules
{
    ...
    {
        $out = [];
        foreach (self::resolve(['dashboard', 'cointelligence', 'analytics']) as $module) {
            $out[] = self::shape($module);
        }
    ...
    public static function resolve(array $liveIds, array $overrides = [], array $extra = []): array
    {
        ...
        $resolved = [];
        foreach ($out as $module) {
            $resolved[] = self::shape($module);
        }
    ...
    private static function catalog(): array
    {
        return [
            ...
            self::m(
                ...
                'Co-Intelligence',
                'Workspace',
                '/admin/anokii/cointelligence',
                'The public graph and corpus health, and the no-PII question log.',
                true,
            ...
            self::m(
                ...
                'Identity',
                'Workspace',
                '/admin/anokii/identity',
                'Define who you are, pillar by pillar.',
                true,
            ...
            self::m(
                ...
                'Workspace',
                '/admin/anokii/drive',
                'Sovereign file storage, scoped to you.',
                true,
            ...
            self::m(
                ...
                'Documents',
                'Workspace',
                '/admin/anokii/documents',
                'Preview, version, and discuss documents in one place.',
                true,
            ...
            self::m(
                ...
                'Workspace',
                '/admin/anokii/pages',
                'Edit and publish the public website, with full revision history.',
                true,
            ...
            self::m(
                ...
                'Venture Tracker',
                'Workspace',
                '/admin/anokii/venture',
                'A live working board across ventures.',
                true,
            ...
            self::m(
                ...
                'Venture Numbers',
                'Workspace',
                '/admin/anokii/ventures',
                'The revenue model, lane by lane: scenarios, assumptions, gating facts.',
                true,
            ...
            self::m(
                ...
                'Workspace',
                '/admin/anokii/rooms',
                'Secure, time-bound spaces with full audit trails.',
                true,
            ...
            self::m(
                ...
                'Workspaces',
                'Workspace',
                '/admin/anokii/workspaces',
                "Run projects without them living in someone's inbox.",
                true,
            ...
            self::m(
                ...
                'Workspace',
                '/admin/anokii/portal',
                'Run the public website and member portal from one place.',
                true,
            ...
            self::m(
                ...
                'Analytics',
                'Insight',
                '/admin/anokii/analytics',
                'First-party, cookie-less site analytics, in your own database.',
                true,
            ...
            self::m(
                ...
                'Administration',
                '/admin/anokii/vault',
                'Credentials and confidential records, locked down.',
                true,
            ...
            self::m(
                ...
                'Governance',
                'Administration',
                '/admin/anokii/governance',
                'See who has access and where data lives.',
                true,
    ...
    /**
     * Re-assert the canonical module shape over an open module row, so a preset
     * that promises the shape delivers it whatever an override supplied.
     *
    ...
    {
        return [
            'id' => Values::str($module['id'] ?? null),
            'label' => Values::str($module['label'] ?? null),
            'group' => Values::str($module['group'] ?? null),
            'live' => Values::bool($module['live'] ?? null),
            'href' => Values::str($module['href'] ?? null),
            'desc' => Values::str($module['desc'] ?? null),
            'icon' => Values::str($module['icon'] ?? null),
            'badge' => Values::str($module['badge'] ?? null),
            'tile' => Values::bool($module['tile'] ?? null),
        ];
    }
